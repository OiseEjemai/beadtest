...
const AirtimePurchaseForm = ({ onClose }) => {
  ...
  return (
    <div>
      ...
      <button onClick={handlePurchase} disabled={isAnyFieldEmpty()} className="px-4 py-2 bg-gray-500 text-white text-base font-medium rounded-md w-full shadow-sm hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-300">Purchase</button>
